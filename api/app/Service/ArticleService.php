...
class ArticleService
{
    ...
    public function getList($params)
    {
        $list = $this->articleModel->getList(['id', 'title', 'desc', 'cover', 'click_num', 'content_html', 'cat_id', 'is_show', 'created_at', 'updated_at'], $params, function ($query) use ($params) {
            ...
            if (isset($params['tag_id']) && $params['tag_id'] != '') {
                $query->whereHas('articleTags', function ($_query) use ($params) {
        ...
        $list->each(function ($item) {
            ...
            $item->is_show_text = \App\Model\Article::$is_show[$item->is_show];
    ...
    {
        $list = $this->articleModel->getList(['id', 'title', 'created_at', 'updated_at'], [], function ($query) {
